...
/*--------------------------------------------------------------------------
Devuelve un valor de radio seg�n las proporciones de una esfera.
--------------------------------------------------------------------------*/
float fRadioEsfera(float y) 
{
	float r = sqrt(pow(alturaFigura / 2, 2) - pow(y, 2));
	return r;
}
...
void esferaAlambre() 
{
	formaAlambre(alturaFigura, nAnillos, fRadioEsfera);
}
